...
interface PersonalizedSubmissionHistoryProps {
  questionId: Id<"personalizedCodingQuestions">;
  onSelectSubmission?: (
    submissionId: Id<"personalizedCodingSubmissions">
  ) => void;
  selectedSubmissionId?: Id<"personalizedCodingSubmissions"> | null;
}
...
export function PersonalizedSubmissionHistory({
  questionId,
  onSelectSubmission,
  selectedSubmissionId,
}: PersonalizedSubmissionHistoryProps) {
  const submissions = useQuery(
    api.queries.personalizedCodingQuestions
      .getPersonalizedCodingSubmissionsForQuestion,
    { questionId }
  );
  ...
  return (
    <div className="divide-y divide-slate-700/50">
      {submissions.map((submission) => (
        <SubmissionRow
          key={submission._id}
          submission={submission as SubmissionSummary}
