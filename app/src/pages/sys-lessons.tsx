...
export default function SysLessonsPage() {
  const PAGE_SIZE = 12;
  ...
  const allTags = useQuery(api.queries.sysLessons.getAllSysLessonTags);
  ...
  const { results, status, loadMore } = usePaginatedQuery(
    api.queries.sysLessons.listSysLessonsPaginated,
    queryArgs,
  ...
  const handleUpvote = async (lessonId: Id<"sysLessons">) => {
    try {
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-zinc-500 mt-2">
              Browse system-generated lessons and open one to read the full
              content
            </p>
          </div>
          ...
          <div className="mt-8 space-y-3">
              ...
              <PaginationContent>
                <PaginationItem>
                  <PaginationPrevious
                    ...
                    className={cn(
                      resolvedCurrentPage <= 1 && "pointer-events-none opacity-50"
                    )}
                  />
                </PaginationItem>
                ...
                <PaginationItem>
                  <PaginationNext
                    ...
                    className={cn(
                      status === "LoadingMore" && "pointer-events-none opacity-50",
                      status === "Exhausted" &&
            ...
            {status === "LoadingMore" && (
              <div className="text-center text-sm text-zinc-500">
                Loading more system lessons...
              </div>
            )}
            {status === "Exhausted" && (
              <div className="text-center text-sm text-zinc-500">
                No more system lessons to load
              </div>
            )}
          </div>
        )}
